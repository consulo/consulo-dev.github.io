...
Compared to [Swing `JTextArea`](https://docs.oracle.com/javase/8/docs/api/javax/swing/JTextArea.html), the *Consulo's* editor component has a ton of advantages: syntax highlighting support, code completion, code folding and much more.
...
* Call [`PsiDocumentManager.getInstance().getDocument()`](https://github.com/consulo/consulo/blob/master/modules/base/language-api/src/main/java/consulo/language/psi/PsiDocumentManager.java) to get the document corresponding to the code fragment;
