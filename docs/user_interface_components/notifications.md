...
For an overview, refer to [Notifications](https://jetbrains.design/intellij/controls/notifications/) in _Consulo UI Guidelines_.
...
For UI reference, see [Balloon](https://jetbrains.design/intellij/controls/balloon/) in _Consulo UI Guidelines_.
