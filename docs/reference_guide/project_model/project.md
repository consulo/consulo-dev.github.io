...
In the *Consulo*, a project encapsulates all the source code, libraries, and build instructions into a single organizational unit.
...
The *Consulo* stores the project configuration data in XML files.

The project and workspace settings are stored in a number of XML files under the `%project_home_directory%/.idea` directory.
...
* [`consulo.project.Project`](https://github.com/consulo/consulo/blob/master/modules/base/project-api/src/main/java/consulo/project/Project.java)
* [`consulo.module.content.ProjectRootManager`](https://github.com/consulo/consulo/blob/master/modules/base/module-content-api/src/main/java/consulo/module/content/ProjectRootManager.java)
* [`consulo.project.ProjectManager`](https://github.com/consulo/consulo/blob/master/modules/base/project-api/src/main/java/consulo/project/ProjectManager.java)
* [`consulo.module.content.ProjectFileIndex`](https://github.com/consulo/consulo/blob/master/modules/base/module-content-api/src/main/java/consulo/module/content/ProjectFileIndex.java)

### Getting a List of Source Roots for All Modules in a Project
Use the [`ProjectRootManager.getContentSourceRoots()`](https://github.com/consulo/consulo/blob/master/modules/base/module-content-api/src/main/java/consulo/module/content/ProjectRootManager.java) method.
...
Use the [`ProjectFileIndex.getContentRootForFile()`](https://github.com/consulo/consulo/blob/master/modules/base/module-content-api/src/main/java/consulo/module/content/ProjectFileIndex.java) and [`ProjectFileIndex.getSourceRootForFile()`](https://github.com/consulo/consulo/blob/master/modules/base/module-content-api/src/main/java/consulo/module/content/ProjectFileIndex.java) methods.
For example:
...
Utility classes used for modifying the project structure can be found in the project model packages, including [`ModuleRootModificationUtil`](https://github.com/consulo/consulo/blob/master/modules/base/module-content-api/src/main/java/consulo/module/content/util/ModuleRootModificationUtil.java).
