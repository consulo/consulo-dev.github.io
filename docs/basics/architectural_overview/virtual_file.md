...
A [`VirtualFile`](https://github.com/consulo/consulo/blob/master/modules/base/virtual-file-system-api/src/main/java/consulo/virtualFileSystem/VirtualFile.java) (VF) is the *Consulo's* representation of a file in a [Virtual File System (VFS)](/basics/virtual_file_system.md).
...
:  - [`LocalFileSystem.getInstance().findFileByIoFile()`](https://github.com/consulo/consulo/blob/master/modules/base/virtual-file-system-api/src/main/java/consulo/virtualFileSystem/LocalFileSystem.java)
- [`VirtualFileManager.findFileByNioPath()`](https://github.com/consulo/consulo/blob/master/modules/base/virtual-file-system-api/src/main/java/consulo/virtualFileSystem/VirtualFileManager.java)/`refreshAndFindFileByNioPath()` (2020.2 and later)

From a PSI file
: `psiFile.getVirtualFile()` (may return `null` if the PSI file exists only in memory)

From a document
: [`FileDocumentManager.getInstance().getFile()`](https://github.com/consulo/consulo/blob/master/modules/base/document-api/src/main/java/consulo/document/FileDocumentManager.java)
...
A refresh operation can be initiated programmatically using [`VirtualFileManager.syncRefresh()`](https://github.com/consulo/consulo/blob/master/modules/base/virtual-file-system-api/src/main/java/consulo/virtualFileSystem/VirtualFileManager.java)/`asyncRefresh()` or [`VirtualFile.refresh()`](https://github.com/consulo/consulo/blob/master/modules/base/virtual-file-system-api/src/main/java/consulo/virtualFileSystem/VirtualFile.java).
...
If one needs to create a file through VFS, use [`VirtualFile.createChildData()`](https://github.com/consulo/consulo/blob/master/modules/base/virtual-file-system-api/src/main/java/consulo/virtualFileSystem/VirtualFile.java) to create a `VirtualFile` instance and [`VirtualFile.setBinaryContent()`](https://github.com/consulo/consulo/blob/master/modules/base/virtual-file-system-api/src/main/java/consulo/virtualFileSystem/VirtualFile.java) to write some data to the file.
