...
The Program Structure Interface, commonly referred to as just PSI, is the layer in the _Consulo_ responsible for parsing files and creating the syntactic and semantic code model that powers so many of the platform's features.
