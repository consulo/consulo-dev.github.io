...
There are community forums you can join to discuss the Consulo.
...
### Write Documents
We're always looking for new articles about Consulo features as well as documentation for the Consulo Platform.
...
Over the years, users have submitted many issues to the Consulo issue tracker.
Many of the unresolved issues are no longer applicable to the latest version of Consulo, are duplicates, or require additional information to be resolved.
...
### Write a Plugin
One of the best ways to contribute a larger piece of code, adding extra functionality to Consulo, is by writing a plugin.
You can submit a plugin to the [Consulo Plugin Repository](https://plugins.consulo.app), making it available for all users.
