...
It's possible to run and debug a plugin directly from *Consulo*.
...
For information on how to change the Run/Debug configuration profile, refer to the Consulo documentation on Run/Debug Configurations.

Using *Consulo*'s debugger, you can find out the origin of the run-time errors and exceptions.
