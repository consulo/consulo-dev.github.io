...
Please see `VirtualFileGist` and `PsiFileGist` documentation.

**Example:**
- `ImageInfoIndex` calculating image dimensions/bit depth needed to be displayed in specific parts of UI.
